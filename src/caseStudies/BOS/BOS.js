...
const BOS = () => {
  return (
    <div>
      <div>
        <div className="container w-container"><img src={title} alt="" /></div>
      </div>
      <div className="section">
        <div className="grey-box">
          <div className="left-text-block">
            ...
            <br />
            <a href="https://www.scamblock.org/wp/" target="_blank">https://www.scamblock.org/wp/</a>
          ...
          <div className="right-text-block">
            ...
            <br />
            <br />
            Blockers of Scam (BOS) mission statement is to stop the rising threat that is online scams. As designers, we were tasked with creating a platform that complimented the existing scamBlock Chrome extension in its goal of reporting potentially dangerous websites and social media profiles. New implementations like the forum and achievement system allow users to reliably verify their reports against those of other trusted users, thereby fostering community engagement.side of a div block.
          </div>
        </div>
      </div>
        ...
        <div className="container-3 w-container">
          <div className="w-layout-grid grid-2">
            <div id="w-node-0f58a5c4230f-7f41fa68">
              <a href="#profile" data-w-id="de50c5e5-51c6-805e-4c44-219da8b53a23" className="w-inline-block"><img src={profile} alt="" className="image" /></a>
              <div className="div-block-2" />
              <div className="text-block-3">Profile</div>
            </div>
            <div id="w-node-96e5f251c335-7f41fa68">
              <div>
                <a href="#news-feed" data-w-id="67296549-8f81-824f-3b4c-18d43c9f27b9" className="w-inline-block"><img src={newsfeed5x} alt="" className="image" /></a>
                <div className="div-block-2" />
                <div className="text-block-3">Newsfeed</div>
              </div>
            </div>
            <div id="w-node-5586ed07a57f-7f41fa68">
              <a href="#forum" data-w-id="46735080-ce82-4727-f5dc-cead8f5fd38d" className="w-inline-block"><img src={forumtilt} alt="" className="image" /></a>
              <div className="div-block-2" />
          ...
          <div className="w-layout-grid grid-3">
            <div id="w-node-03555895dbec-7f41fa68">
              <div>
                <a href="#service" data-w-id="6f06da31-1882-c112-d8e5-5ee6f8795e08" className="w-inline-block"><img src={services5x} alt="" className="image" /></a>
                <div className="div-block-2" />
            ...
            <div id="w-node-c4bfd3dd4bac-7f41fa68">
              <div>
                <a href="#aboutus" data-w-id="c0d742b2-1c31-8794-ca02-0acf10f1ed26" className="w-inline-block"><img src={about2} alt="" className="image" /></a>
                <div className="div-block-2" />
            ...
            <div id="w-node-7755fa8d1ef0-7f41fa68">
              <div>
                <a href="#faq" data-w-id="1ee00c94-68ef-36f9-09db-229a3b2a89d3" className="w-inline-block"><img src={faq2} alt="" className="image" /></a>
                <div className="div-block-2" />
                <div className="text-block-3">FAQ</div>
              </div>
            </div>
            <div id="w-node-f7b05b1deb2e-7f41fa68">
              <a href="#marketing" className="w-inline-block"><img src={marketing5x} data-w-id="cd2e44d3-d1c8-cbf6-1582-f7b05b1deb2f" alt="" className="image" /></a>
              <div className="div-block-2" />
      ...
      <div className="section-3">
        <div className="w-container">
          <div>
            ...
            <div className="div-block" />
            <div>
              <div className="text-block-4">Redesign the current BOS website to match the business goals and accompany the scamBlock extension.</div>
            </div>
            <div className="w-layout-grid grid-4">
              <div className="block">
                <div className="text-block-5">Business Goals</div>
                <div className="text-block-6">The business goal is to develop a platform that is user friendly and community driven to help keep the internet browsing a safer space.</div>
              </div>
              <div className="block">
                <div className="text-block-5">User Goals</div>
                <div className="text-block-6">The user goals within this space is to gain and provide information on ways to browse the internet in a safe space without falling victim of scams.</div>
              </div>
              <div className="block">
                <div className="text-block-5">Designer Goals</div>
                <div className="text-block-6">Our team goal is to create clean, usable pages with intuitive site architecture while keeping the users in mind.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grey-box column">
          ...
          <div className="w-layout-grid grid-5">
            ...
            <div className="text-block-7">
              ...
              {' '}
              is an established company that combines AI powered algorithms along with a user report system to identify malicious sites. However, they do not have an extension and lack a space for their community to interact.
            </div>
            <div className="text-block-8">
              <strong>WOT</strong>
              {' '}
              is a competitor of scamBlock that gives reputation and rating to websites. They regularly post blogs in their platform, but seem to lack a sense of community.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="section-6">
        <div className="w-container">
          <div>
            ...
            <div className="div-block-3"><img src={forumnow} width="526" alt="" className="image-3" /></div>
          ...
          <div className="w-layout-grid grid-6">
            ...
            <div className="text-block-11">We noticed that the rate of people posting and commenting went up by 82% compared to how it was before the redesign.</div>
          </div>
        </div>
      </div>
      <div id="profile" className="section-7">
        <div className="w-container">
          ...
          <div className="div-block-4"><img src={group112} alt="" className="image-4" /></div>
          <div className="text-block-9">
        ...
        <div className="w-container">
          ...
          <div className="newsfeed-blocks">
            <div className="newsfeed-block-1">
              <div className="newsfeed-text-block">For the body section of the newsfeed where visitors can browse more content, we wanted to keep it minimal and organized. Rather than an infinite scroll of the content seen in the original design, we designed smaller cards which can stack side by side and give visitors a quick glimpse of the story details.</div>
      ...
      <div id="marketing" className="section-9">
        <div className="w-container">
          ...
          <div className="text-block-13-copy">The Marketing page is the first page that the user lands on to learn more about their new product, which is the ScamBlock chrome extension. So the page has the ScamBlock logo and the tag line followed by the “Add to Chrome” CTA to notify the user of the purpose of the extension and get them to download it.</div>
          <div className="div-block-5"><img src={marketingheader} alt="" /></div>
          <div className="text-block-13-copy">This is followed by the marketing video provided by the client for the extension in case the user wants to know more about the product. Some users, however, will prefer to read the main features of the product instead of sitting through a 90 second video, so the next section highlights these key features.</div>
          <div className="div-block-6"><img src={marketingvideo} alt="" /></div>
          <div className="text-block-13-copy">Finally, we added customer testimonials at the bottom to establish more credibility for the product and instil the feeling of community into the user. Once again, there is a “Add to Chrome” CTA at the bottom for users who scrolled all the way down and are now convinced they want to download the extension.</div>
        </div>
      </div>
      <div id="service" className="section-10">
        <div className="w-container">
          ...
          <div className="text-block-13-copy">We added a banner at the top to briefly inform the user of the details of the services provided by the company. They then select the plan suitable for them - each plan is displayed as a separate card with specific colours for differentiation. We added another section to promote the chrome extension since that is another new product the company provides followed by the “Add to Chrome” CTA, to optimally use this space for marketing.</div>
        ...
        <div className="w-container">
          <div>
            ...
            <div className="w-layout-grid grid-8">
              <div className="text-block-13-copy">The original About Us page was cluttered, hard to read with little to no information hierarchy. We wanted to ensure as a user that copy was kept concise without taking away the company’s mission statement. To bring together the design of the overall website, we used graphical elements for each section and kept the sections to a minimum which created some text to image hierarchy making it easier to read.</div>
      ...
      <div id="faq" className="section-12">
        <div className="w-container">
          ...
          <div className="text-block-13-copy">FAQ pages can sometimes be tricky depending on the business. They are made to help customers get their questions answered quickly without having to spend too much time looking. Instead of a long scroll of countless questions and answers, we took the approach of eliminating these mass blocks of text with category drop-down menus. Creatively, these drop-down menus help create a more minimalistic look that ties into the overall website design. Contrary, this also helps guide a user to their answer faster by organizing frequently asked questions into  category specific sections.</div>
