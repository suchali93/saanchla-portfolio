        ...
        <Col lg={6} className="d-flex justify-content-center">
          {isVerticallyStacked ? (
            <Box>
              <Carousel>
                <Carousel.Item>
                  <img src={about1crop} alt="" />
                </Carousel.Item>
                <Carousel.Item>
                  <img src={about2crop} alt="" />
                </Carousel.Item>
                <Carousel.Item>
                  <img src={about3crop} alt="" />
                </Carousel.Item>
                <Carousel.Item>
                  <img src={about4crop} alt="" />
                </Carousel.Item>
              </Carousel>
            </Box>
          ) : (
        ...
        <Col lg={6}>
          <Box className={isVerticallyStacked ? 'pt-5' : 'px-4'}>
            ...
            <P>
              ...
              range of people and developed a keen ability to tangibly assess their skill
              set, and apply that towards my clients’ needs. Most importantly, I learned
              to make the candidate the focus of the process. Communication and empathy is
              what I’m all about. This is what led me to pursue a career in UX design.{' '}
              <b>
                I discovered that my background in psychology, experience in HR and
                knowledge of user-centred design gives me a holistic understanding of user
                behaviours, allowing me to always put the user first.
              </b>
            </P>
            <P>
            ...
            <P>
              I am currently working as a freelance Product Designer where I’m able to own
              the full design process, and collaborate with some truly brilliant people. I
              am also a seasoned participant of usertesting.com, which further enhances my
              insights into creating fulfilling user experiences. I am constantly looking
              to improve my skills and welcome feedback.
            </P>
            <P>
