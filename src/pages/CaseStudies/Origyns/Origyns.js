...
import { CenteredImage, Section, SubSection, CenteredBox } from '../styledComponents';
    ...
    >
      ...
      <Box className="mb-7">
        ...
        <P>
          ...
          furniture online. I had to identify what works well, and what could be improved
          in the current landscape. Finally, I had to design a website that seamlessly
          imitates the in-store shopping experience since Origyns does not have a physical
          store.
        </P>
      </Box>
      ...
      <Box className="mb-7">
        As online presence becomes more significant than ever for the furniture industry,
        the first question is how to bridge the online-offline gap and offer engaging
        virtual experiences to your customers. Shopping for furnitures online allows users
        to explore different options at any time from anywhere. However, there are some
        concerns that stop users from shopping furniture online:
        <P>
          <ul>
        ...
        <P>
          Given that users have to rely on images to feel comfortable in the online store,
          it is essential to provide an impeccable visual experience.
        </P>
      </Box>
      ...
      <Box className="mb-7">
        I put together a short survey to learn as much as possible about the target users
        <Row className="my-5">
      ...
      <Box className="mb-7">
        To learn more about the motivations of my users, I talked to 5 millennials who are
        currently looking to buy furniture online. Following are their shared insights and
        frustrations:
        <Row className="my-4">
          <Col
            sm={12}
        ...
        <P>
          <ul>
            ...
            <li>
              <b>High quality product images</b> and <b>360-degree view</b> help shoppers
      ...
      <SubSection>Keeping the user at the centre of my design moving forward</SubSection>
      <Box className="mb-4">
      ...
      <Banner caseStudy={ORIGYNS}>
        How might we enable millenials (ages 30-40) confidently create and purchase fully
        customizable furniture online?
      </Banner>
      ...
      <Box className="mb-7">
        <P>
          In order to bridge the online-offline gap and offer engaging virtual experiences
          to users, it is essential to create a visually rich product page. I came up with
        ...
        <P>
          <ul>
            <li className="pb-3">
              ...
              more accurately than photography. Additionally, interactive room scenes can
              also be designed to simplify product visualization. Due to a{' '}
              <b>budget constraint</b>, this option was shelved to be used in future
              iterations.
            </li>
            <li>
              <b>360-degree product images:</b> This is the best way to compensate for the
              lack of tactile sense, which is of high importance, especially when it comes
              to furniture purchases. This was a more <b>feasible</b> option that was
              selected, without compromising the overall user experience.
            </li>
          </ul>
        </P>
      </Box>
        ...
        <P>
          <ul>
            <li>
              ...
              quality product images, and detailed product description are going to drive
              their purchase decision since they won’t be able to see the products in
              person
            </li>
            <li>
            ...
            <li>
              <b>Custom design quote:</b> For users who want to build custom furniture, a
              form that allows them to easily enter details to get an estimated cost
            </li>
          </ul>
        </P>
      </Box>
      ...
      <Box className="mb-7">
        Once I was clear on the user flow, I started to sketch out the possible solution.
        Using inspirations from other existing UI components from apps like Wayfair,
        BoConcept, Joybird, I started sketching different ideas.
        <Row>
      ...
      <Box className="mb-7">
        The prototype underwent usability testing with 5 participants. Testers were given
        a series of simple tasks to complete. The results from usability testing were used
        to inform my design changes for the final iteration.
        <P>
          <ol>
            <li className="mb-7">
            ...
            <li className="mb-7">
              ...
              <div className="font-sm">
                4/5 testers did not like the idea of scrolling up to see the product image
                when they selected a certain customization option
              </div>
            ...
            <li className="mb-7">
              Product description, dimensions and relevant information was re-organized to
              below the fold
              <div className="font-sm">
      ...
      <Box className="mb-7">
        With the final flow of screens established, I worked alongside another UI Designer
        to develop the visual identity of the brand before creating the high-fidelity
        prototype. The brand is described as <b>luxurious</b>, <b>modern</b>,{' '}
        <b>minimalistic</b>, <b>trustworthy</b>
        and <b>unique</b>.
        <P>
          Using these adjectives, we searched for inspiration and created a colour palette
          which reflected these words. For typography, we used a font that evoked the same
          feeling.
        </P>
      ...
      <Box className="mb-7">
        ...
        attentive sales people. An attractive online store that allows customers to browse
        freely and be inspired will give them more confidence buying online.
        <CenteredImage width="900px" src={images.hifi1} />
      </Box>

      <Banner fluid caseStudy={ORIGYNS} height="550px">
        <CenteredImage margin="0" maxHeight="550px" src={images.mid} alt="" />
      </Banner>
      ...
      <Banner caseStudy={ORIGYNS} height="19rem">
        “Saanchla designed, wireframed, created our company’s entire UX and UI for Origyns
        nearly by herself. She’s a talented designer with skills that reach beyond just
        design as she’s always looking for ways to push the boundaries of how we can make
        our product better.”
      ...
      <Box className="mb-7">
        ...
        <ul>
          ...
          <li>
            <b>AR room planner:</b> Ability to view products in accurate 3D detail within
            a room as per your measurements will also help the user bring their design
            vision to life
          </li>
        </ul>
      </Box>
      ...
      <Box className="mb-7">
        ...
        <P>
          ...
          comes to the features or final designs, but also who the target user is that we
          are designing for. This helps them understand my design decisions and helps with
          a seamless handoff.
        </P>
      </Box>
    </CaseStudy>
