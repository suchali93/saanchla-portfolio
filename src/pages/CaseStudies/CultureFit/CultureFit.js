    ...
    >
      <Container className="d-block">
        <Content heading="Overview">
          CultureFit is a platform for recruiters to evaluate candidates beyond the
          resume, by focussing on workplace culture fit. This was completed as an
          individual project during the full-time UX Program at Brainstation.
        </Content>
        <Content heading="Identifying the Problem Space">
          ...
          <Content heading="Market Research on Current Initiatives" level={2}>
            ...
            <b>cross-functional selection committee</b> in the screening process, or
            giving the candidate a <b>company tour</b> to understand their workplace
            culture. However, all of these measures are <b>time-consuming</b> and{' '}
            <b>not data-driven</b>.
          </Content>
        </Content>
        ...
        <Content heading="Empathizing with the Target Users">
          ...
          hypothesis that creating a platform to assess the alignment of a candidate to
          the workplace culture will help recruiters in the selection process, and reduce
          turnover.
          <Content heading="Interview Participant Criteria" level={2}>
            <List listStyle="none">
              <ListItem>
                ...
                need assistance with the selection process and less likely to rely on “gut
            ...
            <Grid container>
              <Grid item lg={7} md={6} sm={12} xs={12}>
                <Box
                  ...
                  pr={isMobile ? 0 : 4}
                >
                  Overall, recruiters were aware that workplace culture fit is important
                  and lack of it leads to high turnover.
                  <br />
                  <br />
                  <br />
        ...
        <Content heading="Understanding the Target Users">
          ...
          for my persona in order{' '}
          <b>to identify possible opportunities for intervention</b>
          .
        ...
        <Content heading="User Stories and Task Flow">
          ...
          the series of steps to <b>create a customized candidate assessment</b>.
        ...
        <Content heading="Usability Testing">
          ...
          <P>
            ...
            candidates’ alignment with Amazon’s workplace culture, specifically in the
            role of a UX Designer. They will then <b>look up the results of assessment</b>{' '}
          ...
          <Content heading="Key Changes" level={2}>
            <Grid container>
              ...
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <Box pl={isMobile ? 0 : 3}>
                  <div>
                    Some screens were were too information dense and needed to be broken
                    up
                  </div>
        ...
        <Content heading="Marketing Website for CultureFit">
          <Grid container>
            <Grid item lg={7} md={6} sm={12} xs={12}>
              As an additional challenge, I created a landing page for a responsive
              website to market CultureFit. The main goal of this website was to advertise
              my app’s value proposition in order for my target users to want to download
              the app.
              <P>
        ...
        <Content heading="Future Considerations">
          ...
          <List>
            <ListItem margin="10px 0 0">
              A way to integrate the app with existing Applicant Tracking Systems to
              export applicant data into the app. This would also help to email selected
              candidates from the app
            </ListItem>
            <ListItem margin="0">
              A statistics page to view employee retention and turnover rates to see if
              the app has helped combat the problem of high turnover
            </ListItem>
            <ListItem margin="0">
                ...
                <Paper square elevation={2}>
                  <Box p={4}>
                    ...
                    <P>
                      ...
                      invaluable. What might be obvious to you might not be to the user.
              ...
              <Grid item lg={4} md={4} sm={12} xs={12}>
                <Paper square elevation={2}>
                  <Box p={4}>
                    ...
                    <P>
                      Quick and rough iterations before moving to a digital medium can
                      help to speed up the process and prevent wasted time.
                    </P>
                  </Box>
                </Paper>
              </Grid>
