    ...
    >
      ...
      <Content heading="Market Research" level={2}>
        <p>
          ...
          along with a user report system to identify malicious sites. However, they do
          not have an extension and lack a space for their community to interact.
        </p>
        <p>
      ...
      <Content heading="Forum" level={2}>
        ...
        <p>
          ...
          is telephone, followed by online social networking. Ideally it would be best to
          target mobile devices via an app to best mitigate scams used in the social
          networking space. However, due to budget and time constraints, an extension was
          used in order to focus on a much simpler platform. The forum allows the
        ...
        <p>
          ...
          the existing forums we examined were not user-friendly and often contained many
          irrelevant functions. In order to motivate users to utilise the forum, we aimed
          to make the user experience less complicated and more suitable for our
          determined persona.
        </p>
        <p>
      ...
      <Content heading="Profile and Achievements" level={2}>
        ...
        warn individual users of potentially dangerous webpages, why would users even find
        themselves on our site in the first place? Community engagement. Alone, the term
        means nothing - after all, our users can and do engage with each other on the
        countless social networking mediums out there. Our challenge, then, was to pick up
        their slack and provide a platform where users who are concerned by the current
        state of Internet security can reliably communicate and help one another. There’s
        an anonymity that comes with the Internet that is not conducive with the concept
        of Internet security. Many of our interviewees found it difficult to trust and
        engage with anonymous profiles online, regardless of if they were giving or
        soliciting advice. To offset this effect, we took a beat from the gamification
        trend of 2020 to foster legitimacy within our Scamblockers community. By creating
        profiles with associated achievements, we were able to commodify activity on our
        site and give users a reason to both post and reply on the forum. Those who visit
        our site can verify the Internet security advice they come across against the
        profile/achievements of the original poster, in addition to the replies, simply by
        clicking on the poster’s profile image.
      </Content>

      <Content heading="Newsfeed" level={2}>
        For the redesign of the newsfeed page we decided to take inspiration from existing
        news websites. The original website did not have a hero section to capture
        visitor’s attention and was lacking hierarchy in the typography and design. In the
        new design we included a carousel section, where breaking news is featured.
        Visitors can easily see the latest stories and become immediately aware of the
        most common scams affecting people today. The images and texts are large in this
        section and are visually captivating to keep the visitors interested on this page.
        For the body section of the newsfeed where visitors can browse more content, we
        wanted to keep it minimal and organized. Rather than an infinite scroll of the
        content seen in the original design, we designed smaller cards which can stack
        side by side and give visitors a quick glimpse of the story details. To provide a
        better browsing experience we wanted to keep the original idea of filtering
        through the stories based on scam types. We conducted an internal card sort to
        determine the information architecture of the filter tags. This was to ensure the
        broadest categories were captured while allowing for further expansion in the
        future, if needed. Finally, to foster a sense of community between the forum and
        the newsfeed a “Real-Time Data Hub” was added to keep track of statistics. At a
        glance, users are able to see the number of members in their community and their
      ...
      <Content heading="Marketing Page" level={2}>
        ...
        ScamBlock logo and the tag line followed by the “Add to Chrome” CTA to notify the
        user of the purpose of the extension and get them to download it. This is followed
        by the marketing video provided by the client for the extension in case the user
        wants to know more about the product. Some users, however, will prefer to read the
        main features of the product instead of sitting through a 90 second video, so the
        next section highlights these key features. Finally, we added customer
        testimonials at the bottom to establish more credibility for the product and
        instil the feeling of community into the user. Once again, there is a “Add to
        Chrome” CTA at the bottom for users who scrolled all the way down and are now
        convinced they want to download the extension.
      </Content>
      ...
      <Content heading="About Us" level={2}>
        ...
        without taking away the company’s mission statement. To bring together the design
        of the overall website, we used graphical elements for each section and kept the
        sections to a minimum which created some text to image hierarchy making it easier
        to read.
      </Content>

      <Content heading="FAQ Page" level={2}>
        FAQ pages can sometimes be tricky depending on the business. They are made to help
        customers get their questions answered quickly without having to spend too much
        time looking. Instead of a long scroll of countless questions and answers, we took
        the approach of eliminating these mass blocks of text with category drop-down
        menus. Creatively, these drop-down menus help create a more minimalistic look that
        ties into the overall website design. Contrary, this also helps guide a user to
        their answer faster by organizing frequently asked questions into category
        specific sections.
      </Content>
