  ...
  return (
    ...
    >
      <Content heading="Overview">
        VR Teams is a virtual reality extension for Microsoft Teams targeted at young
        ...
        <P>Our solution was VR Teams, a virtual reality...</P>
      </Content>
      <Content heading="Researching the Problem Space">
        COVID-19 is reshaping what work looks like and experts are asking whether working
        from home will become the ‘new normal’.
        <P>
          While working from home can be great, it can be a struggle for many as it fails
          to emulate the human connections and collaborative effort that come as a result
          of sharing a physical space.
        </P>
        <P>
          “Statistics Canada found that 4.6 million Canadians who don’t normally work from
          home started to in response to the pandemic, based on a survey conducted the
          week of March 22, 2020”.
        </P>
        <P>
          “According to a survey conducted by Vancouver based polling firm Research Co.,
          73% of Canadians surveyed think the working from home trend will continue after
      ...
      <Content heading="Empathizing with the Target Users">
        ...
        working from home today for further insights into the problem space, and gathered
        the following common frustrations of working from home.
        <Box mt={5}>
            ...
            <Grid item lg={4} md={4} sm={12} xs={12}>
              <Paper square elevation={2}>
                <Box p={4}>
                  <b>Communication</b>
                  <P>
                    Young professionals find communication during isolation frustrating as
                    the inability to reach colleagues in real-time cause delays and missed
                    opportunities.
                  </P>
                  <P>
      ...
      <Content heading="Understanding the Target Users">
        ...
        created a persona and experience map to capture our target user’s journey as they
        interact with the product. This allowed us to address the persona’s frustrations
        and identify possible opportunities to intervene.
        <Grid container>
      ...
      <Content heading="Our Solution">
        One of the main frustrations of our persona, Chris, was the lack of connectedness.
        So we decided to think outside the box, and explore virtual reality (VR) tech
        space. As the VR tech space grows more and more in popularity, VR headsets and
        controllers are becoming increasingly affordable and portable. With this
        knowledge, our team wanted to leverage this technology and imagined how this
        advancement in technology can change the way people work from home.
        <P>
          Our solution was to create a virtual reality extension of Microsoft Teams called
          VR Teams. The idea was to simulate a face-to-face collaboration with your
          colleagues. This solution can help combat lonelinesss for those missing out on
          that small talk in the office, and also provide virtual spaces to work in with
          colleagues.
        </P>
      </Content>
        ...
        <Grid container>
          <Grid item lg={4} md={4} sm={12} xs={12}>
            <Box pr={isMobile ? 0 : 4}>
              ...
              />
              <div>
                VR Teams tab added to navigation menu of Microsoft Teams. Before entering
                VR Teams, prompt on the screen reminds you to give access to mic and to
                wear your headset in order to view any VR rooms.
              </div>
            </Box>
          </Grid>
          <Grid item lg={4} md={4} sm={12} xs={12}>
          ...
          <Grid item lg={4} md={4} sm={12} xs={12}>
            <Box pl={isMobile ? 0 : 4}>
              ...
              <div>
                ...
                tasks and productivity. They can also set a clock to remind themselves of
                when to take breaks or end their work day.
              </div>
            </Box>
          </Grid>
        </Grid>
          ...
          <Grid item lg={4} md={4} sm={12} xs={12}>
            <Box pr={isMobile ? 0 : 5}>
              ...
              <div>
                ...
                industry. Each display is a customized dashboard for the user, with things
                like how long they have been in VR, a widget of their email, and upcoming
                schedule.
              </div>
            </Box>
          </Grid>
      ...
      <Content heading="Division of Work">
        ...
        presentation to pitch our product, we divided our team into groups to tackle these
        tasks.
        <List>
        ...
        <P>
          While all the members supported each other in their roles, I was responsible for
          asset collection and image sourcing as well as part of the UI design. An
        ...
        <Box mb={10}>
          <Grid container>
            <Grid item lg={5} md={5} sm={12} xs={12}>
              VR Teams was designed to create a space for users to feel more engaged with
              their co-workers while improving overall collaboration and productivity.
              This initial prototype was built using Figma / Photoshop for design, and
              DraftXR for prototyping.
              <Box
                display="flex"
            ...
            <Grid item lg={5} md={5} sm={12} xs={12}>
              <Box height="100%" display="flex" alignItems="center" pr={isMobile ? 0 : 4}>
                <div>
                  ...
                  <P>
                    This page shows the company’s default common rooms open for anyone to
                    join when it is active.
                  </P>
                  <P>
                    Clicking on any room gives information on meeting details & number of
                    participants before you join.
                  </P>
                  <P>
            ...
            <Box height="100%" display="flex" alignItems="center" pr={isMobile ? 0 : 4}>
              <div>
                ...
                <P>
                  ...
                  lights to dim at a certain time to signify the end of your working day.
                </P>
              </div>
            </Box>
          </Grid>
      ...
      <Content heading="Future Considerations">
        ...
        for VR Teams.
        <P>
          <b>Adaptation</b> –– To ensure a seamless experience for users, we will consider
          integrating an auto-sync function of files into Microsoft’s existing cloud
          software and other Microsoft Teams functions. This way users are able to access
          any files whether they are inside or outside of VR Teams.
        </P>
        <P>
        ...
        <P>
          <b>Accessibility</b> –– In order to ensure this product is usable for all users,
          we need to consider WCAG AAA Compliance, and conduct usability tests to ensure
          complaince with accessibility standards.
        </P>
        <P>
